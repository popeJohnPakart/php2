      ...
      <div>
        <div class="media">
          ...
          <div class="article">
            ...
            <ul>
              <li>
                <form method="post" action="buyhelmsproccess.php">

                  <table>
                   <tr><th>Helm Name</th><th>Item Class</th><th>Strength</th><th>Constitution</th><th>Price</th><th>Buy?</th></tr>
                   <tr>
                    <td>
                      <input type="hidden" name="name" value="Chain Helm">Chain Helm
                    </td>
                    <td>
                      <input type="hidden" name="class" value="Helm">Helms
                    </td>
                    <td>
                ...
                <form method="post" action="buyhelmsproccess.php">
                 <tr>
                  <td>
                    <input type="hidden" name="name" value="Plate Helm">Plate Helm
                    <td>
                      <input type="hidden" name="class" value="Helm">Helms
                    </td>
                    <td>
