...
require_once 'story16-fight-troll-functions.php';
...
{
    echo '<img src="images/troll1.jpg" width="500px"><br><br>';
...
echo"<center>";
  ...
  $Monster = $sql->getMonster('Troll');

  echo '<img src="images/troll.jpg" height="450px"><br><br>';
