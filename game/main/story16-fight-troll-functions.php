...
function Table($Monster, $User)
{
  ...
  echo "<form action=\"story16-fight-troll.php\" method=\"post\">";
  echo "<table>
  <tr>
    <td>";
...
function CalcDamage($Att, $Def)
{
  ...
  $Damage=(400/10)+($Att['Strength']-$Def['Constitution'])*0.5;
...
<td align=\"center\"> <font color='white'>Congratulations! You killed the $Monster[Name]!<br />
  ...
  <form action=\"story16-fight-troll.php\" method=\"post\">
 ...
 echo "<a href='story17.html'><input class=\"button\" type='Submit' value='Continue Story'><br /></a>";
