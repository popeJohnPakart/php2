...
$items = $sql->getItems($itemName,$id);
 ...
 if($result['Gold']<$Worth)
  {
    print "Click <a href='buyhelms.php'>here</a> to go back.";
    die("Not enough gold!");
  }
  ...
  {
        $addItems = $sql->getItemInfo1($result['ID'],$itemName,$itemClass,$str,$const,$Worth,$Amount);
        $id = $sql->addItems1();
...
?><script>alert("Thank you for buying");
  window.location = "buyhelms.php"; </script>
