...
function CalcDamage($Att, $Def)
{
  ...
  $Damage=(300/10)+($Att['Strength']-$Def['Constitution'])*0.5;
...
<td align=\"center\"> <font color='white'>Congratulations! You killed the $Monster[Name]!<br />
  ...
  <form action=\"story11-fight-hiruyoki.php\" method=\"post\">
 ...
 echo "<a href='story12.html'><input class=\"button\" type='Submit' value='Continue Story'><br /></a>";
