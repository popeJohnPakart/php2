...
require_once 'story9-fight-mage-functions.php';
...
{
    echo '<img src="images/mage.jpg" width="500px"><br><br>';
...
echo"<center>";
  ...
  $Monster = $sql->getMonster('Mage');

  echo '<img src="images1/best-game1.jpg" width="500px"><br><br>';
