...
require_once 'story27-fight-shinigami-function.php';
...
{
    echo '<img src="images/shinigami1.jpg" width="500px"><br><br>';
...
echo"<center>";
  ...
  $Monster = $sql->getMonster('Shinigami');

  echo '<img src="images/shinigami.jpg" height="450px"><br><br>';
