      ...
      <div>
        <div class="media">
          ...
          <div class="article">
            ...
            <ul>
              <li>
                <form method="post" action="buylegarmorproccess.php">

                  <table>
                   <tr><th>Armor Name</th><th>Item Class</th><th>Constitution</th><th>Dexterity</th><th>Price</th><th>Buy?</th></tr>
                   <tr>
                    <td>
                      <input type="hidden" name="name" value="Chain Leggings">Chain Leggings
                    </td>
                    <td>
                      <input type="hidden" name="class" value="Leg Armor">Leg Armor
                    </td>
                    <td>
                ...
                <form method="post" action="buylegarmorproccess.php">
                 <tr>
                  <td>
                    <input type="hidden" name="name" value="Plate Leggings">Plate Leggings
                    <td>
                      <input type="hidden" name="class" value="Leg Armor">Leg Armor
                    </td>
                    <td>
