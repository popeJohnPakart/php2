      ...
      <div>
        <div class="media">
          ...
          <div class="article">
            ...
            <ul>
              <li>
                <form method="post" action="buyglovesproccess.php">

                  <table>
                   <tr><th>Gloves Name</th><th>Item Class</th><th>Dexterity</th><th>Intelligence</th><th>Price</th><th>Buy?</th></tr>
                   <tr>
                    <td>
                      <input type="hidden" name="name" value="Chain Gloves">Chain Gloves
                    </td>
                    <td>
                      <input type="hidden" name="class" value="Gloves">Gloves
                    </td>
                    <td>
                ...
                <form method="post" action="buyglovesproccess.php">
                 <tr>
                  <td>
                    <input type="hidden" name="name" value="Plate Gloves">Plate Gloves
                    <td>
                      <input type="hidden" name="class" value="Gloves">Gloves
                    </td>
                    <td>
