...
require_once 'story11-fight-hiruyoki-functions.php';
...
{
    echo '<img src="images/hiruyoki.jpg" width="500px"><br><br>';
...
echo"<br><br><br><br><br>";
echo"<center>";
  echo "<form action='story11-fight-hiruyoki.php' method='post'>";


  $Monster = $sql->getMonster('Hiruyoki');

  echo '<img src="images1/games.jpg" width="500px"><br><br>';
