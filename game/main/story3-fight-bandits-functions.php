...
function CalcDamage($Att, $Def)
{
  ...
  $Damage=(100/10)+($Att['Strength']-$Def['Constitution'])*0.5;
...
<td align=\"center\"> <font color='white'>Congratulations! You killed the $Monster[Name]!<br />
  ...
  <form action=\"story3-fight-bandits.php\" method=\"post\">
 ...
 echo "<a href='story4.html'><input class=\"button\" type='Submit' value='Continue Story'><br /></a>";
