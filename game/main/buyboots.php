      ...
      <div>
        <div class="media">
          ...
          <div class="article">
            ...
            <ul>
              <li>
                <form method="post" action="buybootsproccess.php">

                  <table>
                   <tr><th>Boots Name</th><th>Item Class</th><th>Strength</th><th>Constitution</th><th>Price</th><th>Buy?</th></tr>
                   <tr>
                    <td>
                      <input type="hidden" name="name" value="Chain Boots">Chain Boots
                    </td>
                    <td>
                      <input type="hidden" name="class" value="Boots">Boots
                    </td>
                    <td>
                ...
                <form method="post" action="buybootsproccess.php">
                 <tr>
                  <td>
                    <input type="hidden" name="name" value="Plate Boots">Plate Boots
                    <td>
                      <input type="hidden" name="class" value="Boots">Boots
                    </td>
                    <td>
