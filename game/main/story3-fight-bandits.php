...
require_once 'story3-fight-bandits-functions.php';
...
if(isset($Fight)&&!isset($Action))
{
  ...
  else
  {
    ...
    if($Monster['Type']==0)
    {
      $Monster['HP']=100;
      $Monster['MP']=100;
      $Monster['Strength']=rand($Max/5-$Monster['Level'],$Max/5+$Monster['Level'])."<br>";
      $Monster['Constitution']=rand($Max/5-$Monster['Level'],$Max/5+$Monster['Level'])."<br>";
      $Monster['Dexterity']=rand($Max/5-$Monster['Level'],$Max/5+$Monster['Level'])."<br>";
      $Monster['Intelligence']=rand($Max/5-$Monster['Level'],$Max/5+$Monster['Level'])."<br>";
...
{
    echo '<img src="images/bandits.jpg" width="500px"><br><br>';
...
echo"<br><br><br><br><br>";
echo"<center>";
  echo "<form action='story3-fight-bandits.php' method='post'>";


  $Monster = $sql->getMonster('Bandits');

  echo '<img src="images1/game1.jpg" width="500px"><br><br>';
